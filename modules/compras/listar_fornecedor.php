...
$sql = "SELECT id, nome, cnpj FROM fornecedores";
...
<body>
            ...
            <tbody>
                <?php while($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_fornecedor.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn-edit">Editar</a>
    ...
    <?php else : ?>
        <p>Não há fornecedors cadastrados.</p>
    <?php endif; ?>
